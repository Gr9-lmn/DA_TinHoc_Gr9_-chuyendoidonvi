...
namespace ChuyenDoi
{
    public class TemperatureUnit : Unit
    {
        ...
        public override double ConvertTo(Unit unit, double value)
        {
            ...
            if (Symbol == "°Ra" && value < 0 ) { throw new ArgumentException($" {Symbol} không thể bé hơn 0...!!!"); }
            if (Symbol == "°De" && value < 559.725 ) { throw new ArgumentException($" {Symbol} không thể bé hơn 559.725...!!!"); }
